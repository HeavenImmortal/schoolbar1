...
public class AliYunOssUtils {
    ...
    //阿里云的accessKeyId
    private String accessKeyId = "LTAI4G2QbHBcp2axj4geUVwk";

    //阿里云的accessKeySecret
    private String accessKeySecret = "I6sw9dliAP72C4lFlN7bbsZY4QyzDj";

    //空间
    private String bucketName = "heavenimmortal";
    ...
    //自定义上传文件夹
    public AliYunOssUtils(String filedir) {
